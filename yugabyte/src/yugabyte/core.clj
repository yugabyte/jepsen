...
(def workloads-ysql
  ...
  #:ysql{:none               noop-test
         ...
         :sz.append          (with-client append/workload-serializable (ysql.append/->Client :serializable :pessimistic))
         ...
         :rc.append          (with-client append/workload-rc (ysql.append/->Client :read-committed :pessimistic))
         ...
         :si.append          (with-client append/workload-si (ysql.append/->Client :repeatable-read :pessimistic))
