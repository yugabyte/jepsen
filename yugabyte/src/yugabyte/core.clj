...
(def ysql-rc-workloads
  #:read-committed {:append (with-client append/workload-rc (ysql.append/->Client :read-committed))})

(def ysql-si-workloads
  #:snapshot-isolation {:append (with-client append/workload-rc (ysql.append/->Client :repeatable-read))})

(def ysql-se-workloads
  #:serializable {:none            noop-test
                  :sleep           sleep-test
...
(def workloads-ysql
  "A map of workload names to functions that can take option maps and construct workloads."
  #:ysql{:read-committed     ysql-rc-workloads
         :serializable       ysql-se-workloads
         :snapshot-isolation ysql-si-workloads})
